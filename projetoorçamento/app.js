...
cadastrarDespesas = () =>{
   ...
   let despesa = new Despesa(
    ...
    if (despesa.validarDadados() ){
        ...
        document.getElementById('modal_conteudo').innerHTML = 'Campos não foram preenchidos corretamente'
...
carregaListaDespesa =(despesas = Array(), filtro = false)=> {
